...
<title>Malware Detect Monitor Digest for {{HOSTNAME}}</title>
<style type="text/css">
...
<!-- Meta bar: simplified — threat badge -->
<tr>
<td style="background-color:#f4f4f5;padding:8px 24px;border-bottom:1px solid #d4d4d8;">
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
<td style="color:#52525b;font-size:11px;font-weight:bold;text-transform:uppercase;letter-spacing:1px;">Monitor Digest</td>
<td align="right" style="white-space:nowrap;font-size:11px;">
<span style="display:inline-block;background-color:#dc2626;color:#ffffff;padding:2px 10px;border-radius:10px;font-weight:bold;font-family:'Courier New',Courier,monospace;">{{TOTAL_HITS}} threat(s)</span>
</td>
</tr>
</table>
</td>
...
<tr>
<td style="padding:3px 0;color:#71717a;">Mode</td>
<td style="padding:3px 0;color:#09090b;">Inotify digest</td>
</tr>
<tr>
<td style="padding:3px 0;color:#71717a;">Runtime</td>
<td style="padding:3px 0;color:#09090b;">{{MONITOR_RUNTIME}} &nbsp;&middot;&nbsp; {{TOTAL_FILES}} files</td>
</tr>
</table>
</td>
</tr>
